        ...
        <div class="navbar-left d-flex align-items-center gap-3">
            <div class="navbar-brand d-flex align-items-center gap-5 m-0">
                <div class="mobile-nav-toggler">
                    <img src="{{ asset('backend') }}/images/icon/hamburger.svg" alt="">
                </div>
        ...
        <div class="navbar-right  d-flex align-items-center">
            <div class="navbar-action d-flex gap-3">
                ...
                <div class="notifications position-relative">
                    <a href="{{ route('admin.request.products') }}?status=1"
                        class="action-link position-relative dropdown-toggle">
                        <img src="{{ asset('backend') }}/images/icon/nav_notification_icon.svg" alt="">
                        <span class="badge text-bg-danger">{{ $pending_product_req }}</span>
                    </a>
                </div>
                ...
                <div class="profile position-relative" data-bs-toggle="tooltip" data-bs-placement="bottom"
                    ...
                    <div class="action-link  dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ auth()->user()?->avatar ?: asset('assets/images/no_mage.svg') }}" alt=""
