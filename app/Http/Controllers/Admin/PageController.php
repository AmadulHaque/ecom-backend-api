...
class PageController extends Controller
{
    ...
    public function showSectionDetails($slug)
    {
        ...
        $pageSectionDelails = PageSectionDetailsService::pageSectionWiseDetails($pageSection->id);

        return view('backend.pages.pages.section.details', compact('pageSectionDelails', 'pageSection'));
    }
